...
namespace ShellExample.Droid.Renderer
{
    public class PageContainerViewRenderer : ViewRenderer<PageContainerView, Android.Views.View>
    {
        ...
        public PageContainerViewRenderer(Context context) : base(context)
        {
            _context = context;
        }
        ...
        private void DisplayPCVContent(Page pageToDisplay)
        {
            ...
            if (pageToDisplay != null)
            {
                ...
                {
                    var renderer = Platform.CreateRendererWithContext(pageToDisplay, _context);
